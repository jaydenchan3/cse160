...
Matrix4.prototype.concat = function(other) {
  ...
  // If e === b, copy b first so we don't overwrite while reading
  if (e === b) {
...
// Set this matrix to a translation
...
// Multiply on the right by a translation
...
// Multiply on the right by a scale
...
// Set this matrix to a rotation (angle in degrees) around axis (x,y,z)
Matrix4.prototype.setRotate = function(angle, x, y, z) {
  ...
  if (0 !== x && 0 === y && 0 === z) {
    ...
    if (len !== 1) { rlen = 1/len; x*=rlen; y*=rlen; z*=rlen; }
    nc = 1 - c;
    xy = x*y; yz = y*z; zx = z*x;
    xs = x*s; ys = y*s; zs = z*s;

    e[ 0] = x*x*nc +  c; e[ 4] = xy *nc - zs; e[ 8] = zx *nc + ys; e[12] = 0;
    e[ 1] = xy *nc + zs; e[ 5] = y*y*nc +  c; e[ 9] = yz *nc - xs; e[13] = 0;
    e[ 2] = zx *nc - ys; e[ 6] = yz *nc + xs; e[10] = z*z*nc +  c; e[14] = 0;
    e[ 3] = 0;           e[ 7] = 0;           e[11] = 0;           e[15] = 1;
  }
  return this;
};

// Multiply on the right by a rotation
...
// Transpose in place. Needed (with setInverseOf) to build a normal matrix.
...
// Set this matrix to the inverse of `other` (full 4x4 cofactor inverse).
